...
def get_snomed_code_umls(term):
    base_url = "https://uts-ws.nlm.nih.gov/search/current"
    api_key = "45f92a04-c9f1-4792-aff8-81e803604fa8"
    params = {
        "apiKey": api_key,
        "string": term,
        "sabs": "SNOMEDCT_US",
...
with DAG(
    ...
    snomed_results = fetch_snomed_code.expand(entity=entities)
    aggregated = aggregate_results(snomed_results)
